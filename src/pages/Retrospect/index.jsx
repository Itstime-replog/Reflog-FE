...
import BookImage from "../../assets/images/Retroimg/Book.svg";
import ChevronDown from "../../assets/images/Retroimg/Chevron-Down.svg";
import LockIcon from "../../assets/images/Retroimg/Lock.svg";
import UnlockIcon from "../../assets/images/Retroimg/Unlock.svg";
...
const Retrospect = () => {
  ...
  const [selectedLearningTag, setSelectedLearningTag] = useState(null);
  ...
  const handleTagClick = (tag) => {
    setSelectedFilterTag(selectedFilterTag === tag ? null : tag);
  };
  ...
  const handleSubmit = () => {
    const newJournal = {
      ...
      learningTags: selectedLearningTag ? [selectedLearningTag] : [],
      performanceValue,
      understandingValue,
      goodTags: selectedGoodTags,
      badTags: selectedBadTags,
  ...
  const handleEdit = () => {
    if (selectedJournal) {
      ...
      setUnderstandingValue(selectedJournal.understandingValue);
      setSelectedGoodTags(selectedJournal.goodTags);
      setSelectedBadTags(selectedJournal.badTags);
      setImprovement(selectedJournal.improvement);
      setIsLocked(selectedJournal.isLocked);
      setIsDetailOpen(false);
